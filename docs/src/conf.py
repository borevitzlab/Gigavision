...
project = 'Gigavision'
copyright = '2017, Gareth Dunstone, Chuong Nguyen, Tim Brown'
author = 'Gareth Dunstone, Chuong Nyugen'
...
texinfo_documents = [
    (master_doc, 'Gigavision', 'Gigavision Documentation',
     author, 'SpectroPhenoClimatronEyePI', 'Gigavision, panorama camera .',
     'Miscellaneous'),
]
